...
class CaptioningTransformer(nn.Module):
    ...
    def __init__(self, word_to_idx, input_dim, wordvec_dim, num_heads=4,
        ...
        self.embedding = nn.Embedding(vocab_size, wordvec_dim, padding_idx=self._null)#_null不会对梯度产生贡献
    ...
    def forward(self, features, captions):
        ...
        mask=torch.tril(mask,0)#下三角阵，从(0,0)开始保留，其余为0。说明第1行只有第一个为1，其余全为0
